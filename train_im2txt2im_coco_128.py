...
image_size = 128      # image size for txt2im
...
def generator_txt2img_resnet(input_z, net_rnn_embed=None, is_train=True, reuse=False, is_large=False):
    ...
    gf_dim = 196    # <- gen filters in first conv layer [196] https://github.com/reedscot/icml2016/blob/master/scripts/train_coco.sh
...
def discriminator_txt2img_resnet(input_images, net_rnn_embed=None, is_train=True, reuse=False):
    ...
    with tf.variable_scope("discriminator", reuse=reuse):
        ...
        ##
        # net_h = Conv2d(net_h3, df_dim*4, (1, 1), (1, 1), act=None,
        #         padding='VALID', W_init=w_init, name='d_h3/conv2d3')
        # net_h = BatchNormLayer(net_h, act=lambda x: tl.act.lrelu(x, 0.2),
        #         is_train=is_train, gamma_init=gamma_init, name='d_h3/batchnorm3')
        # net_h = Conv2d(net_h, df_dim*4, (3, 3), (1, 1), act=None,
        #         padding='SAME', W_init=w_init, name='d_h3/conv2d4')
        # net_h = BatchNormLayer(net_h, act=lambda x: tl.act.lrelu(x, 0.2),
        #         is_train=is_train, gamma_init=gamma_init, name='d_h3/batchnorm4')
        # net_h = Conv2d(net_h, df_dim*8, (3, 3), (1, 1), act=None,
        #         padding='SAME', W_init=w_init, name='d_h3/conv2d5')
        # net_h = BatchNormLayer(net_h, #act=lambda x: tl.act.lrelu(x, 0.2),
        #         is_train=is_train, gamma_init=gamma_init, name='d_h3/batchnorm5')
        # net_h3.outputs = tl.act.lrelu(net_h.outputs + net_h3.outputs, 0.2)
        ##
        ...
        if net_rnn_embed is not None:  # 232
            ...
            net_reduced_text.outputs = tf.tile(net_reduced_text.outputs, [1, 8, 8, 1], name='d_tiled_embeddings')
